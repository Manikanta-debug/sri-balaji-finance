            ...
            try {
                ...
                for (const dKey in days) {
                    ...
                    for (const session of sessions) {
                        ...
                        const villagesSnap = await getDocs(villagesCol);
                        ...
                        for (const vDoc of villagesSnap.docs) {
                            ...
                            villageStatsMap[vData.name].borrowed += vStats.totalBorrowed;
                            villageStatsMap[vData.name].repaid += vStats.totalRepaid;
                            villageStatsMap[vData.name].borrowers += vStats.totalBorrowers;
                        }
                    }
                }
