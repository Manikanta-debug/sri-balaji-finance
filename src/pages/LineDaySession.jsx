...
export default function LineDaySession({ unlockedLines, setUnlockedLines }) {
    ...
    useEffect(() => {
        ...
        if (lineId) fetchLineInfoAndVillages();
    }, [lineId, day, session]);
    ...
    const updateBorrower = async (borrowerId, updatedData) => {
        ...
        if (updatedData.loan) {
            // Check for Borrowed amount change (e.g. during Repay & Renew)
            ...
            <div className="sticky top-0 z-20 flex justify-between items-center p-2 md:p-4 bg-yellow-400 text-black shadow">
                ...
                <div className="flex items-center gap-3 ml-auto">
                    <button
                        ...
                        className="px-3 py-1 rounded bg-yellow-400 hover:bg-yellow-500 text-black text-sm cursor-pointer"
                    >
                        Prev
                    </button>
